...
- Run `omg size <package>` for package disk usage.
...
- Size: `./.pi/skills/verify-omg/bin/verify-omg drive inspect-size -- size glibc`; require exit zero and a numeric size with an explicit unit.
