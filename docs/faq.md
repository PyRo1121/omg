...
Node, Python, Go, Rust, Ruby, Java, Bun, and Pi. Unsupported names fail explicitly. Providers may require external tools; not every manager is a self-contained Rust implementation. See [runtime management](./runtimes.md).
