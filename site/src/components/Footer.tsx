      ...
      <div class="mx-auto max-w-7xl">
        ...
        <div class="mb-8 rounded-2xl border border-white/5 bg-slate-900/50 p-6">
          <div class="mb-4 flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-slate-300">Project Activity</span>
          </div>
          <a
            href="https://github.com/PyRo1121/omg"
            target="_blank"
            rel="noopener noreferrer"
            class="block overflow-hidden rounded-lg transition-opacity hover:opacity-80"
          >
            <img
              src="https://ghchart.rshah.org/6366f1/PyRo1121"
              alt="PyRo1121's GitHub contribution graph"
              class="w-full"
              loading="lazy"
            />
          </a>
