...
\`\`\`bash
gh attestation verify omg-v${version}-x86_64-linux-arch.tar.gz -R PyRo1121/omg --source-ref refs/tags/v${version} --signer-workflow PyRo1121/omg/.github/workflows/release.yml
\`\`\`
